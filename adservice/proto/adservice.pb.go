...
const file_proto_adservice_proto_rawDesc = "" +
	"\n" +
	"\x15proto/adservice.proto\x12\rmicroshopping\".\n" +
	"\tAdRequest\x12!\n" +
	"\fcontext_keys\x18\x01 \x03(\tR\vcontextKeys\"1\n" +
	"\n" +
	"AdResponse\x12#\n" +
	"\x03ads\x18\x01 \x03(\v2\x11.microshopping.AdR\x03ads\";\n" +
	"\x02Ad\x12!\n" +
	"\fredirect_url\x18\x01 \x01(\tR\vredirectUrl\x12\x12\n" +
	"\x04text\x18\x02 \x01(\tR\x04text2L\n" +
	"\tAdService\x12?\n" +
	"\x06GetAds\x12\x18.microshopping.AdRequest\x1a\x19.microshopping.AdResponse\"\x00B\x17Z\x15./proto;microshoppingb\x06proto3"

var (
	file_proto_adservice_proto_rawDescOnce sync.Once
	file_proto_adservice_proto_rawDescData []byte
)

func file_proto_adservice_proto_rawDescGZIP() []byte {
	file_proto_adservice_proto_rawDescOnce.Do(func() {
		file_proto_adservice_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_adservice_proto_rawDesc), len(file_proto_adservice_proto_rawDesc)))
	})
	return file_proto_adservice_proto_rawDescData
}

var file_proto_adservice_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_proto_adservice_proto_goTypes = []any{
...
func file_proto_adservice_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_adservice_proto_rawDesc), len(file_proto_adservice_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
