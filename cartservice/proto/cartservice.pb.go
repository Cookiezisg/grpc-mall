...
const file_proto_cartservice_proto_rawDesc = "" +
	"\n" +
	"\x17proto/cartservice.proto\x12\rmicroshopping\"E\n" +
	"\bCartItem\x12\x1d\n" +
	"\n" +
	...
	"\x04item\x18\x02 \x01(\v2\x17.microshopping.CartItemR\x04item\"+\n" +
	...
	"\x04Cart\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12-\n" +
	"\x05items\x18\x02 \x03(\v2\x17.microshopping.CartItemR\x05items\"\a\n" +
	"\x05Empty2\xd6\x01\n" +
	"\vCartService\x12@\n" +
	"\aAddItem\x12\x1d.microshopping.AddItemRequest\x1a\x14.microshopping.Empty\"\x00\x12?\n" +
	"\aGetCart\x12\x1d.microshopping.GetCartRequest\x1a\x13.microshopping.Cart\"\x00\x12D\n" +
	"\tEmptyCart\x12\x1f.microshopping.EmptyCartRequest\x1a\x14.microshopping.Empty\"\x00B\x17Z\x15./proto;microshoppingb\x06proto3"

var (
	file_proto_cartservice_proto_rawDescOnce sync.Once
	file_proto_cartservice_proto_rawDescData []byte
)

func file_proto_cartservice_proto_rawDescGZIP() []byte {
	file_proto_cartservice_proto_rawDescOnce.Do(func() {
		file_proto_cartservice_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_cartservice_proto_rawDesc), len(file_proto_cartservice_proto_rawDesc)))
	})
	return file_proto_cartservice_proto_rawDescData
}

var file_proto_cartservice_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_proto_cartservice_proto_goTypes = []any{
...
func file_proto_cartservice_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_cartservice_proto_rawDesc), len(file_proto_cartservice_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
